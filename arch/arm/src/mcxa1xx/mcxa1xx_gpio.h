/****************************************************************************
 * arch/arm/src/mcxa1xx/mcxa1xx_gpio.h
 *
...
#ifndef __ARCH_ARM_SRC_MCX_MCXA1XX_MCXA1XX_GPIO_H
#define __ARCH_ARM_SRC_MCX_MCXA1XX_MCXA1XX_GPIO_H

/****************************************************************************
 * Included Files
 ****************************************************************************/

#include "hardware/mcxa1xx_gpio.h"
...
/* GPIO pinset is a 16-bit word used to configure the GPIO settings.
...
#define MCXA1XX_GPIO_BASE(n)      g_gpio_base[n]  /* Use GPIO1..GPIOn macros as indices */

#define MCXA1XX_GPIO_VERID(n)     (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_VERID_OFFSET)
#define MCXA1XX_GPIO_PARAM(n)     (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PARAM_OFFSET)
#define MCXA1XX_GPIO_LOCK(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_LOCK_OFFSET)
#define MCXA1XX_GPIO_PCNS(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PCNS_OFFSET)
#define MCXA1XX_GPIO_ICNS(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_ICNS_OFFSET)
#define MCXA1XX_GPIO_PCNP(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PCNP_OFFSET)
#define MCXA1XX_GPIO_ICNP(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_ICNP_OFFSET)
#define MCXA1XX_GPIO_PDOR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PDOR_OFFSET)
#define MCXA1XX_GPIO_PSOR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PSOR_OFFSET)
#define MCXA1XX_GPIO_PCOR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PCOR_OFFSET)
#define MCXA1XX_GPIO_PTOR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PTOR_OFFSET)
#define MCXA1XX_GPIO_PDIR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PDIR_OFFSET)
#define MCXA1XX_GPIO_PDDR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PDDR_OFFSET)
#define MCXA1XX_GPIO_PIDR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_PIDR_OFFSET)
#define MCXA1XX_GPIO_GICLR(n)     (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_GICLR_OFFSET)
#define MCXA1XX_GPIO_GICHR(n)     (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_GICHR_OFFSET)

/* Interrupt status flags, these have two channels. Channel is selected by
 * setting / clearing ICRN.IRQS bit.
 */

#define MCXA1XX_GPIO_ISFR0(n)     (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_ISFR0_OFFSET)
#define MCXA1XX_GPIO_ISFR1(n)     (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_ISFR1_OFFSET)

/* GPIO PIN[0...31] and ICR[0...31] */

#define MCXA1XX_GPIO_P0DR(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_P0DR_OFFSET)
#define MCXA1XX_GPIO_PNDR(n, p)   (MCXA1XX_GPIO_P0DR(n) + ((p) * 0x4))
#define MCXA1XX_GPIO_ICR0(n)      (MCXA1XX_GPIO_BASE(n) + MCXA1XX_GPIO_ICR0_OFFSET)
#define MCXA1XX_GPIO_ICRN(n, p)   (MCXA1XX_GPIO_ICR0(n) + ((p) * 0x4))
...
#else
#  define mcxa1xx_gpioirq_initialize()
#endif
...
#else
#define mcxa1xx_gpioirq_attach(pinset, isr, arg) 0
#endif
...
#else
#  define mcxa1xx_gpioirq_configure(pinset) 0
#endif
...
#else
#  define mcxa1xx_gpioirq_enable(pinset) 0
#endif
...
#else
#  define mcxa1xx_gpioirq_disable(pinset) 0
#endif
...
#endif
#endif /* __ARCH_ARM_SRC_MCX_MCXA1XX_MCXA1XX_GPIO_H */
